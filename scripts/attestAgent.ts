...
async function verifyAgentResponse(client: ClientHandler, agentResponse: any) {
  ...
  console.log(
    "  ✅ Client successfully verified agent message response: " +
      green +
...
async function main() {
  ...
  if (balance < ethers.parseEther(valueEther)) {
    ...
    await txFund.wait();
    console.log(
      ` 💵 Funded agent address ${responseFromKeyGeneration.response.artifacts?.ethAddress} with ${valueEther} ETH`
    );
  } else {
    console.log(
      ` 💵 Agent address ${
  ...
  console.log(
    ` 📋 Attestation info decoded from Attestation Registry for attestation Id ${attestation.id}`
  );
  ...
  console.log(
    ` ✅ Auth DID Attestation successfully verified from on-chain data.`
  );
  ...
  console.log(` 🆔 Attestation Id: ${ownershipAttestationId}`);
  ...
  console.log(
    ` 📋 Attestation info decoded from Attestation Registry for attestation Id ${ownershipAttestationId}`
  );
  ...
  console.log(
    ` ✅ Agent ownership attestation from owner successfully verified from on-chain data.`
  );
  ...
  console.log(` 🆔 Attestation Id from Agent: ${attestationIdAgent}`);
  ...
  console.log(
    ` 📋 Attestation info decoded from Attestation Registry for attestation Id ${attestationIdAgent}`
  );
